...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      css: {
        src: ['public/lib/bootstrap/dist/css/bootstrap.min.css', 'node_modules/dygraphs/dist/dygraph.min.css', 'public/src/css/**/*.css'],
